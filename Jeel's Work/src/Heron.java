...
public class Heron {
	...
	public static void main(String[] args) throws IOException {
		System.out.println("============================================================================");
        System.out.println("This program will calculate the area of a trianlge using heron's formula");
        System.out.println("============================================================================");
	...
	public static double cal(double x,double y,double x2,double y2,double p,double p2,double p3,double p4,double i1,double i2,double i3,double i4) {
		...
		double s = (distance + distance1+distance2)/2;
		double a = Math.sqrt(s*(s-distance)*(s-distance1)*(s-distance2));
		
		System.out.println("The area is "+a+" units");
